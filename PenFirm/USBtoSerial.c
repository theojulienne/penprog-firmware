 ...
 */
volatile CDC_Line_Coding_t LineEncoding = { .BaudRateBPS = 0,
...
void EVENT_USB_Device_ConfigurationChanged(void)
{
	...
	// penprog data endpoint
	if (!(Endpoint_ConfigureEndpoint(PENPROG_DATA_EPNUM, EP_TYPE_BULK,
...
void ReconfigureUSART(void)
{
	...
	/* Enable interrupt only if baud rate sane */
